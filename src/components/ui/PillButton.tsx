...
export default function PillButton({ variant = "primary", className = "", ...rest }: Props) {
	const base =
		"rounded-full px-6 py-3 text-sm sm:text-base font-semibold transition-all duration-200 focus:outline-none focus-visible:ring-2";
	const styles =
		variant === "primary"
