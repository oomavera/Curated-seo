      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-3 bg-snow/90 rounded-lg border border-slopes/30 focus:border-mountain focus:ring-2 focus:ring-mountain/20 transition-all duration-300 text-midnight placeholder-mountain/60"
        ...
        <button
          ...
          className="w-full bg-midnight text-snow px-6 py-4 rounded-lg text-base font-bold hover:bg-mountain hover:text-snow transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
          style={{
            animation: isSubmitting ? 'none' : 'glow 2s ease-in-out infinite alternate',
            boxShadow: isSubmitting ? '0 4px 6px -1px rgba(0, 0, 0, 0.1)' : undefined
          }}
        >
          {isSubmitting ? (
