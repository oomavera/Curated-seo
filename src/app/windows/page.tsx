...
const bonusFaqItems = [
	{
		question: "What does Seminole County exterior window cleaning include?",
		answer: "We wash exterior glass, frames, and sills; scrub out screens; and squeegee for a streak-free finish. Ladders and water-fed poles let us reach most second-story windows safely, so Seminole County homes get clear views and improved curb appeal.",
	},
	{
		question: "How often should I clean exterior windows in Florida?",
		answer: "Most Seminole County homeowners book exterior window cleaning every 3–4 months to stay ahead of pollen, dust, and hard water spots. Coastal breezes and daily humidity can leave a film quickly, so a quarterly cadence keeps glass bright year-round.",
	},
	{
		question: "Do you remove hard water stains and screen grime?",
		answer: "Yes. We use mineral-safe cleaners and gentle pads to lift hard water spotting from sprinklers, then rinse and squeegee. Screens are brushed, washed, and dried before reinstalling so dirt and pollen don’t transfer back onto freshly cleaned glass.",
	},
	{
		question: "Is your exterior window cleaning safe for landscaping and pets?",
		answer: "Our detergents are biodegradable and lawn-safe, and we protect plants by avoiding overspray and rinsing carefully. We also keep doors and gates closed and use quiet equipment, so pets stay calm while we make your exterior windows shine.",
	},
	{
		question: "Can I bundle gutter, track, or solar panel cleaning?",
		answer: "Absolutely. Many Seminole County clients bundle exterior window cleaning with gutter clears, track detailing, and light pressure rinses. Ask for a combined visit to save a trip fee and get a same-day shine across glass, frames, and fixtures.",
	},
];
			...
			<div className="flex-1 flex flex-col justify-center lg:justify-start px-8 max-w-7xl mx-auto w-full mt-1 sm:mt-6 lg:mt-2">
				...
				<div className="relative z-20 text-center mb-3 sm:mb-6 lg:mb-4 no-blend">
						<h1 className="font-hero text-2xl xs:text-3xl md:text-4xl xl:text-5xl mb-1 leading-tight text-midnight">
							 Seminole County Homeowners: Get your FREE Window Cleaning now!
						</h1>
					</div>
					...
					<div className="flex flex-col md:flex-row gap-6 mb-6 justify-center items-center md:items-start">
						...
						<div className="order-1 md:order-2 w-full md:flex-1 max-w-lg relative mt-0">
							...
							<GlassCard className="p-5 sm:p-6 min-h-[420px]">
								<QuickEstimateForm title="Claim Your Free Cleaning" submitLabel="Get Free Window Cleaning" showEmail={true} openCalendarOnSuccess={false} page="windows" />
							</GlassCard>
						</div>
					</div>
				...
				<ScrollPopupForm
					...
					callout="Wait! Get your FREE Window Cleaning!"
					buttonClassName="bg-black text-white"
					submitLabel="Get Free Window Cleaning"
					page="windows"
				/>
			</div>
			...
			<div className="bg-white text-midnight">
				...
				<section className="py-12 flex flex-col items-center">
					...
					<section id="packages" className="py-12 flex flex-col items-center">
						<GlassCard className="mb-12 w-full max-w-3xl p-4 sm:p-10 transition-transform duration-300 hover:scale-[1.02] overflow-hidden">
