...
export default function DemonstrationPage() {
  ...
  useEffect(() => {
    ...
    // Fallback: listen for the iframe load event to start progress
    const iframe = document.querySelector<HTMLIFrameElement>('iframe.wistia_embed');
    const onLoad = () => startVideoProgressBar();
        ...
        <div className="px-3 pb-3">
          <div className="bg-white rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.15)] border border-black/5 ring-1 ring-black/5">
            <div className="px-5 pt-4 text-center text-midnight text-[18px] leading-snug font-nhd font-medium">
              {isBusinessHours ? (
                <>
                  <span className="italic">We&apos;ll call in</span> <span className="font-extrabold">60 seconds</span><br /><span className="italic">to confirm your</span> <span className="font-extrabold">free cleaning</span><br /><span className="italic">from</span> <span className="font-extrabold">407-470-1780</span>
                </>
              ) : (
                <>
